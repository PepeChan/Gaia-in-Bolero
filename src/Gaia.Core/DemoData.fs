        ...
        [
            {
                ...
                Date = "2026-05-31"
                InputClass = Some "Need"
                Actor = Some "Reader / researcher"
                Mission = Some "Extended reading and research"
                OperationalContext = Some "Large-format calm reading sessions"
...

            {
                ...
                Date = "2026-05-31"
                InputClass = Some "Need"
                Actor = Some "Stylus user"
                Mission = Some "Screen-based handwriting"
                OperationalContext = Some "Writing or drawing directly on the screen"
                Source = "Sphynx architecture / Φ parsing baseline"
...

            {
                ...
                Date = "2026-05-31"
                InputClass = Some "Need"
                Actor = Some "Offline worker"
                Mission = Some "Productive work without network access"
                OperationalContext = Some "Intermittent or unavailable connectivity"
                Source = "Sphynx architecture / Φ parsing baseline"
...

            {
                ...
                Date = "2026-05-31"
                InputClass = Some "Need"
                Actor = Some "Document reviewer"
                Mission = Some "Side-by-side document review"
                OperationalContext = Some "Split-screen document comparison"
                Source = "Sphynx architecture / Φ parsing baseline"
...

            {
                ...
                Date = "2026-05-31"
                InputClass = Some "Constraint"
                Actor = Some "Stylus user"
                Mission = Some "Precise pen interaction"
                OperationalContext = Some "Stylus contact with the cover glass"
                Source = "Sphynx architecture / Φ parsing baseline"
...

            {
                ...
                Date = "2026-05-31"
                InputClass = Some "Need"
                Actor = Some "Mobile user"
                Mission = Some "Untethered tablet operation"
                OperationalContext = Some "Device disconnected from external power"
                Source = "Sphynx architecture / Φ parsing baseline"
...

            {
                ...
                Date = "2026-05-31"
                InputClass = Some "Need"
                Actor = Some "Focused worker"
                Mission = Some "Low-distraction visual work"
                OperationalContext = Some "Focused work sessions"
                Source = "Sphynx architecture / Φ parsing baseline"
...

            {
                ...
                Date = "2026-05-31"
                InputClass = Some "Need"
                Actor = Some "Handheld user"
                Mission = Some "Secure handheld use"
                OperationalContext = Some "Holding the large-format device"
                Source = "Sphynx architecture / Φ parsing baseline"
...

            {
                ...
                Date = "2026-05-31"
                InputClass = Some "Need"
                Actor = Some "Productivity user"
                Mission = Some "Move between reading, writing, and file work"
                OperationalContext = Some "Cross-activity workflow transitions"
                Source = "Sphynx architecture / Φ parsing baseline"
...

            {
                ...
                Date = "2026-05-31"
                InputClass = Some "Concern"
                Actor = Some "Hardware architect"
                Mission = Some "Preserve structural integrity"
                OperationalContext = Some "Thin large-format device handling"
                Source = "Sphynx architecture / Φ parsing baseline"
